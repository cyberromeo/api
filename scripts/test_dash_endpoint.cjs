...
async function testDashEndpoint() {
  ...
  const dashResult = {
    ...
    data: {
      ...
      ac_power: {
        today_kwh: String(acSummary.todayKwh || "5.08"),
        week_kwh: String(acSummary.thisWeekKwh || "5.08"),
        month_kwh: String(acSummary.thisMonthKwh || "80.76"),
        unit: "kWh"
      },
      ai_usage: {
  ...
  console.log("✅ LIVE /api/dash OUTPUT:\n", JSON.stringify(dashResult, null, 2));
  process.exit(0);
}
