 ...
 * GET /api/motra
 * Returns clean JSON payload with overall summary AND all 18 individual muscle recovery metrics
 */
  ...
  try {
    ...
    if (getApps().length) {
      ...
      if (docSnap.exists) {
        ...
        const musclesMap = docData.payload?.musclesMap || defaultMuscles;
        payloadData = {
